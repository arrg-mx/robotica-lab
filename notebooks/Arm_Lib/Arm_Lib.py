...
class Arm_Device(object):
    ...
    def __init__(self):
        ...
        self.i2cprot = i2cprotocol.I2CPrinter()
    ...
    def Arm_serial_servo_write(self, id, angle, time):
        ...
        if id == 0:  # This is the control of all servos
            ...
            try:
                ...
                print(f"[TO_SEND] -> address: {self.addr}, id: {(0x10 + id)}, data[{value_H}, {value_L}, {time_H}, {time_L}]")
                self.i2cprot.print_i2c_block_data(self.addr, 0x10 + id, [value_H, value_L, time_H, time_L])
            except:
    ...
    def Arm_serial_servo_write_offset_state(self):
        try:
            ...
            pass
            time.sleep(.001)
            state = 0 #self.bus.read_byte_data(self.addr, 0x1b)
            return state
        except:
    ...
    def Arm_serial_servo_read(self, id):
        ...
        try:
            ...
            pass
            time.sleep(0.003)
            pos = 0 # self.bus.read_word_data(self.addr, id + 0x30)
        except:
    ...
    def Arm_serial_servo_read_any(self, id):
        ...
        try:
            ...
            pass
            time.sleep(0.003)
            pos = 0 #self.bus.read_word_data(self.addr, 0x37)
        except:
    ...
    def Arm_ping_servo(self, id):
        ...
        if data > 0 and data <= 250:
            ...
            pass
            time.sleep(.003)
            value = 0 # self.bus.read_byte_data(self.addr, reg)
            times = 0
    ...
    def Arm_get_hardversion(self):
        try:
            ...
            pass
            time.sleep(.001)
            value = 0 #self.bus.read_byte_data(self.addr, 0x01)
        except:
    ...
    def Arm_Read_Action_Num(self):
        try:
            ...
            pass
            time.sleep(.001)
            num = 0 # self.bus.read_byte_data(self.addr, 0x22)
            return num
        except:
